...
const ComboDetails = () => {
    ...
    return (
        ...
        <div >
     <div className=" grid grid-cols-1 lg:grid-cols-2 lg:p-16 sm:p-3 lg:ml-20 mt-8 lg:justify-evenly">
       <img src={combo.image} className="w-2/3 ml-16 rounded-lg shadow-2xl" alt=''/>
       <div className='lg:ml-20 lg:mt-10'>
         <h1 className="text-2xl font-bold text-start mt-5 ml-16 ">{combo.title}</h1>
      ...
      <p className="card-title mt-2 font-bold ml-16">{combo.price}</p>
         <p className="text-justify mt-6 lg:mr-20 ml-16">{combo.shortDescription}</p>
         {/* You can open the modal using document.getElementById('ID').showModal() method */}
         <div className='text-start mt-10'>
         <button className="w-28 btn btn-secondary ml-16" onClick={()=>document.getElementById('my_modal_3').showModal()}>Buy</button>
